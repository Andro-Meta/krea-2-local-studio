...
# Scheduler names supported by the ComfyUI Krea graphs (formerly
# krea2.schedulers.ALL_SCHEDULERS in the removed native pipeline).
ALL_SCHEDULERS: tuple[str, ...] = (
    "simple", "normal", "beta", "beta57", "sgm_uniform", "bong_tangent",
    "karras", "exponential",
)
