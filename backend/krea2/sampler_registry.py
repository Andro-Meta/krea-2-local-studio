...
RECOMMENDED_COMBOS: tuple[ComboSpec, ...] = (
    ...
    ComboSpec("er_sde", "beta57", 8, 1.0, "Xperiment closest native", "turbo",
              "Closest native mapping for the ClownsharKSampler_Beta workflow: 8 steps, CFG 1, beta57. Exact ClownsharKSampler_Beta remains external."),
